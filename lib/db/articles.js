...
<p>
    ...
    {
        content: `<p>
    Pocas veces nos da para trabajar con la recursividad en nuestros proyectos, pero cuando podemos, ¡qué maravilla! Me encanta arriesgarme a tener un bucle infinito a cambio de poder tener una mejora de O(log n) en la búsqueda de menús pendientes de pago cada noche.
</p>
<p>
    ¿Sabías que da tantos problemas que la NASA tiene prohibida la recursividad en su código? Lo tienes escrito, junto con 9 reglas más, <a target="_blank" rel="noopener noreferrer" href="https://spinroot.com/p10/">aquí</a>.
</p>
<p>
    A ver cuántas de esas reglas entiendes, high level programmer.
</p>
<p>
    ¿Qué tal hasta ahora el Adviento? Espero que no te estés ofuscando demasiado. Recuerda que pedir ayuda <strong>a un humano</strong> es lo mejor que puedes hacer para mejorar.
</p>
<p>Lunes que viene, otro problema. A partir de ahora, solamente habra un problema por semana, que empiezan a venir las vacaciones, y los sprints.</p>`,
...
<p>
    ¡Recta final! Ya solo queda un problema para acabar este reto. Ojo, porque sera relativamente mas complicado que el resto. Tomate tu tiempo y no te agobies. Dime qué te ha parecido si me encuentras por la oficina, me haría mucha ilusión.&nbsp;
</p>
<p>
