const problems = [
    {
        ...
        <p>Los mas espabilados estan empezando a sobornar al resto para colarse en la fila, desbaratando el orden por completo, aunque tengan el turno original. Sin embargo, el segurata es bastante perezoso, y dejara que la cola continue siempre y cuando la gente no soborne a mas de dos personas cada uno.</p>
